...
DATABASES = {
    'default': {
        ...
        'NAME': 'djangodb',  #資料庫名稱
        'USER': 'djangoapi',  #資料庫帳號
        'PASSWORD': 'djangoapi@innostar.com',  #資料庫密碼
        'HOST': 'aiot0616.antnex.com.tw',  #Server(伺服器)位址
        'PORT': '15432'  #PostgreSQL Port號
        }
}
...
CELERY_BEAT_SCHEDULE = {
    'my-scheduled-task': {
        'task': 'mysite.tasks.my_celery_task',
